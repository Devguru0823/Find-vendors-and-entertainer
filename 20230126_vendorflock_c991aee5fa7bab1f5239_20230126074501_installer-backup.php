...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230126_vendorflock_c991aee5fa7bab1f5239_20230126074501_archive.zip';
        const ARCHIVE_SIZE       = '394075648';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'c991aee-26074501';
        const SECONDARY_PACKAGE_HASH = '1a5fe9a-26074501';
        const VERSION            = '1.5.1';
